pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-cairlsr/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('cairlsr-225')   // <---- Change this to match your kubernetes cluster credentials
    }
